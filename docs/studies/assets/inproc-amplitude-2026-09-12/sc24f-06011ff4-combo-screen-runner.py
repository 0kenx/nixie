...
record is filed. Records land in precompile/107b7868/benchmark/runs/sc24f-combo/
...
BIN = ROOT / "/tmp/elim-combo/target/release/examples/cnf_solve"
CORPUS = ROOT / "precompile/corpus-sc24f"
STORE = ROOT / "bench/suite/scripts/benchstore.py"
OUT = ROOT / "precompile/107b7868/benchmark/runs/sc24f-combo"
CAP_S = 60
SEEDS = [0, 1, 2, 3, 4]
HOST = {"id": "workstation", "cpu": "20 cores", "os": "Linux 7.2.2"}
GIT = {"sha_long": "06011ff4c4f17d16438a01a508f8def0998a083d", "sha_short": "06011ff4", "dirty": False}
