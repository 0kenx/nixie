...
record is filed. Records land in precompile/107b7868/benchmark/runs/sc24f/
...
BIN = ROOT / "precompile/107b7868/stats_solve"
CORPUS = ROOT / "precompile/corpus-sc24f"
STORE = ROOT / "bench/suite/scripts/benchstore.py"
OUT = ROOT / "precompile/107b7868/benchmark/runs/sc24f"
CAP_S = 60
SEEDS = [0, 1, 2, 3, 4]
HOST = {"id": "workstation", "cpu": "20 cores", "os": "Linux 7.2.2"}
GIT = {"sha_long": "107b78686a655de6d03eb4ee301c51386be434b2", "sha_short": "107b7868", "dirty": False}
