...
record is filed. Records land in precompile/281de4c0/benchmark/runs/sc24f/
...
BIN = ROOT / "precompile/281de4c0/stats_solve"
CORPUS = ROOT / "precompile/corpus-sc24f"
STORE = ROOT / "bench/suite/scripts/benchstore.py"
OUT = ROOT / "precompile/281de4c0/benchmark/runs/sc24f"
CAP_S = 60
SEEDS = [0, 1, 2, 3, 4]
HOST = {"id": "workstation", "cpu": "20 cores", "os": "Linux 7.2.2"}
GIT = {"sha_long": "281de4c01943bf022302015172bdacfbe021d5b0", "sha_short": "281de4c0", "dirty": False}
