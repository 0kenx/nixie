...
record is filed. Records land in precompile/93703871/benchmark/runs/sc24f/
...
BIN = ROOT / "precompile/93703871/stats_solve"
CORPUS = ROOT / "precompile/corpus-sc24f"
STORE = ROOT / "bench/suite/scripts/benchstore.py"
OUT = ROOT / "precompile/93703871/benchmark/runs/sc24f"
CAP_S = 60
SEEDS = [0, 1, 2, 3, 4]
HOST = {"id": "workstation", "cpu": "20 cores", "os": "Linux 7.2.2"}
GIT = {"sha_long": "937038714639ae19c05f4d32f88829d79567d6d1", "sha_short": "93703871", "dirty": False}
