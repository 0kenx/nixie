...
record is filed. Records land in precompile/107b7868/benchmark/runs/sc24f-x/
...
BIN = ROOT / "/media/data/proj/nixie/target-onesided/release/examples/cnf_solve"
CORPUS = ROOT / "precompile/corpus-sc24f"
STORE = ROOT / "bench/suite/scripts/benchstore.py"
OUT = ROOT / "precompile/107b7868/benchmark/runs/sc24f-x"
CAP_S = 60
SEEDS = [0, 1, 2, 3, 4]
HOST = {"id": "workstation", "cpu": "20 cores", "os": "Linux 7.2.2"}
GIT = {"sha_long": "0000000000000000000000000000000000000aa1", "sha_short": "onesided1", "dirty": False}
