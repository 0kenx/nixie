# SCIRS2 Policy for nixie-cli

## Policy Statement

This crate (`nixie-cli`) is a **command-line interface** for the Nixie SMT solver and does **NOT** require SciRS2 dependencies.

## Rationale

### Nature of the Project
- **nixie-cli** implements a command-line interface and REPL for SMT solving
