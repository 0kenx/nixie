...
- Created nixie-py crate with full Python API
...
- Created nixie-vscode/ extension package
...
## Dependencies
- **nixie-core**: SMT-LIB2 parser, AST
- **nixie-solver**: Main solver API
- **nixie-opt**: Optimization commands (optional)
...
- [x] Add command history (saved to ~/.nixie_history)
...
- [x] Configuration file support (.nixierc in home directory or config.yaml in config dir)
...
**Interactive guided tutorial for learning Nixie and SMT-LIB2**
...
- [x] Add interpolant generation support (Completed 2026-01-17 - nixie-cli/src/interpolate.rs)

### Advanced Features
- [x] Support for more input formats (TPTP) (Completed 2026-01-17 - nixie-cli/src/tptp.rs)
...
- [x] Add constraint learning and sharing (Completed 2026-01-17 - nixie-cli/src/learning.rs)
- [x] Support for distributed solving (Completed 2026-01-17 - nixie-cli/src/distributed.rs)
...
- [x] Add web-based dashboard for monitoring (Completed 2026-01-17 - nixie-cli/src/dashboard.rs)

### Integration
- [x] Python bindings (PyO3) (Completed 2026-01-17 - nixie-py crate)
- [x] JavaScript/WASM bindings (Completed 2026-01-17 - nixie-cli/src/wasm_bindings.rs, nixie-cli/examples/)
- [x] REST API server mode (Completed 2026-01-17 - nixie-cli/src/server.rs)
- [x] Integration with VS Code extension (Completed 2026-01-17 - nixie-vscode/)
