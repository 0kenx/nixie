...
//!
//! ```rust,ignore
//! use nixie_cli::learning::{LearnedConstraintCache, LearnedClause};
//!
//! // Create a new cache
...
mod tests {
    ...
    fn test_cache_put_get() {
        let cache_path = PathBuf::from("/tmp/nixie_test_learning_cache.json");
    ...
    fn test_lru_eviction() {
        let cache_path = PathBuf::from("/tmp/nixie_test_learning_lru.json");
        let _ = fs::remove_file(&cache_path);
    ...
    fn test_cache_persistence() {
        let cache_path = PathBuf::from("/tmp/nixie_test_learning_persist.json");
        let _ = fs::remove_file(&cache_path);
    ...
    #[test]
    fn test_cache_stats() {
        let cache_path = PathBuf::from("/tmp/nixie_test_learning_stats.json");
        let _ = fs::remove_file(&cache_path);
    ...
    fn test_merge_similar() {
        let cache_path = PathBuf::from("/tmp/nixie_test_learning_merge.json");
        let _ = fs::remove_file(&cache_path);
