...
Core data structures and utilities for Nixie SMT solver.
...
This crate provides the foundational components used across all Nixie crates:
...
```rust
use nixie_core::sort::SortManager;
...
```rust
use nixie_core::ast::TermManager;
use nixie_core::tactic::{Goal, SimplifyTactic};
...
- `nixie-math` - Shared numeric and polynomial utilities
