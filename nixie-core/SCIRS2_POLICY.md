# SCIRS2 Policy for nixie-core

## Policy Statement

This crate (`nixie-core`) is a **pure logic SMT solver core** and does **NOT** require SciRS2 dependencies.

## Rationale

### Nature of the Project
- **nixie-core** implements an SMT (Satisfiability Modulo Theories) solver
