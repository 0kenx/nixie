...
- **nixie-sat**: Term representation, literal mapping
- **nixie-theories**: Sort system, AST traversal, congruence closure
- **nixie-solver**: SMT-LIB2 parser, tactic framework
- **nixie-proof**: Proof nodes, proof rules
