...
//!
//! This example demonstrates how to create and manipulate terms using the Nixie term manager.
//! It covers:
...
//!
//! ## See Also
//! - [`TermManager`](nixie_core::ast::TermManager) for the main API
//! - [`TermKind`](nixie_core::ast::TermKind) for term types

use nixie_core::ast::{TermKind, TermManager};

fn main() {
    println!("=== Nixie Core: Basic Term Creation ===\n");
