...
//!
//! ## See Also
//! - [`parse_script`](nixie_core::smtlib::parse_script) for the main parser
//! - [`Command`](nixie_core::smtlib::Command) for SMT-LIB2 commands

use nixie_core::ast::TermManager;
use nixie_core::smtlib::{Command, parse_script};

fn main() {
    println!("=== Nixie Core: SMT-LIB2 Parsing ===\n");
