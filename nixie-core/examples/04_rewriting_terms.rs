...
//!
//! ## See Also
//! - [`Rewriter`](nixie_core::rewrite::Rewriter) trait
//! - [`BoolRewriter`](nixie_core::rewrite::BoolRewriter)
//! - [`ArithRewriter`](nixie_core::rewrite::ArithRewriter)

use nixie_core::ast::TermManager;
use nixie_core::rewrite::{
...
fn main() {
    println!("=== Nixie Core: Term Rewriting ===\n");
