...
//!
//! ## See Also
//! - [`QeLiteSolver`](nixie_core::qe::QeLiteSolver)
//! - [`MbiSolver`](nixie_core::qe::MbiSolver) for model-based interpolation

use nixie_core::ast::TermManager;
use nixie_core::qe::{QeLiteConfig, QeLiteResult, QeLiteSolver};

fn main() {
    println!("=== Nixie Core: Quantifier Elimination ===\n");
