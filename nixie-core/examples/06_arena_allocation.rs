...
//!
//! ## See Also
//! - [`Arena`](nixie_core::alloc::Arena) for basic arena
//! - [`ObjectPool`](nixie_core::alloc::ObjectPool) for reusable objects
//! - [`Region`](nixie_core::alloc::Region) for scoped allocation

use nixie_core::alloc::{Arena, ArenaConfig, ObjectPool, PoolConfig, Region, SharedObjectPool};
use std::time::Instant;

fn main() {
    println!("=== Nixie Core: Arena Allocation ===\n");
    ...
    let handle2 = arena.alloc(String::from("Hello, Nixie!"));
