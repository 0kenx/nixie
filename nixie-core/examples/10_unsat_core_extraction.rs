...
//!
//! ## See Also
//! - [`UnsatCore`](nixie_core::unsat_core::UnsatCore)
//! - [`UnsatCoreBuilder`](nixie_core::unsat_core::UnsatCoreBuilder)

use nixie_core::ast::{NamedAssertion, TermManager};
use nixie_core::unsat_core::{UnsatCore, UnsatCoreBuilder, UnsatCoreStrategy};

fn main() {
    println!("=== Nixie Core: UNSAT Core Extraction ===\n");
