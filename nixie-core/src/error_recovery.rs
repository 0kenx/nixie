...
mod tests {
    use super::*;
    use crate::error::{NixieError, SourceLocation};
    ...
    fn test_error_batch() {
        ...
        let err1 = ErrorContext::new(NixieError::parse_error(span, "error 1"));
        let err2 = ErrorContext::new(NixieError::parse_error(span, "error 2"));
        let err3 = ErrorContext::new(NixieError::parse_error(span, "error 3"));
