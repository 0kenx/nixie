...
//! # Scope
//!
//! This is `nixie-core`'s own lightweight theory layer: it is self-contained,
...
//! `nixie-solver` actually runs live in the `nixie-theories` crate
//! (`nixie_theories::{bv, fp, datatype, string, array}`) — bit-blasting,
