...
use nixie_core::ast::{Model, ModelValue, SubstitutionBuilder, TermManager, eval_term};
use nixie_core::smtlib::{Command, parse_script};
use nixie_core::tactic::mbp::{MbpEngine, Model as MbpModel};
...
fn cached_evaluator_bv_not_width_64_does_not_panic() {
    use nixie_core::ast::CachedEvaluator;
...
fn managed_tactic_is_reexported_from_tactic_root() {
    ...
    // `nixie_core::tactic::registry::` prefix.
    fn _assert_path<T: ?Sized + nixie_core::tactic::ManagedTactic>() {}
}
