...
//! (see `nixie-core/src/smtlib/parser/commands.rs`).
//!
//! Findings fixed:
...
fn mentions_apply_of(manager: &TermManager, term: nixie_core::ast::TermId, name: &str) -> bool {
    nixie_core::ast::traversal::collect_subterms(term, manager)
        .into_iter()
