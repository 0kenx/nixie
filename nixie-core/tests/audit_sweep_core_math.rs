...
//! (nixie-core side; nixie-math regressions live in
//! `nixie-math/tests/audit_sweep_core_math.rs`).
//!
//! Each test documents the specific defect it guards against; see the
//! corresponding source file for the full rationale.

use nixie_core::ast::model::{FunctionInterpretation, Model as AstModel, ModelValue};
use nixie_core::ast::{CongruenceClosure, EGraph, Explanation};
use nixie_core::model::{Model, ModelCompletion, Value};
use nixie_core::qe::bv::simplification::{BvSimplifier, BvTerm};
use nixie_core::smtlib::Lexer;
use nixie_core::smtlib::Printer;
use nixie_core::tactic::{Goal, Pb2BvTactic, Precision, TacticResult};
use nixie_core::{ArithRewriter, RewriteContext, Rewriter, StringRewriter, TermKind, TermManager};
use num_bigint::BigInt;
use num_rational::Rational64;
use num_traits::Zero;

// ========  ========
// nixie-core/src/rewrite/arith.rs
// ========  ========
...
// ========  ========
// nixie-core/src/ast/congruence.rs
// ========  ========
...
// ========  ========
// nixie-core/src/rewrite/string.rs – codepoint (not byte) semantics
// ========  ========
...
// ========  ========
// nixie-core/src/smtlib/lexer.rs
// ========  ========
...
fn lexer_well_formed_input_has_no_errors() {
    ...
    while !matches!(
        ...
        Some(nixie_core::smtlib::TokenKind::Eof) | None
    ) {}
    assert!(!lexer.has_errors());
}

// ========  ========
// nixie-core/src/qe/bv/simplification.rs – width_mask guard
// ========  ========
...
// ========  ========
// nixie-core/src/tactic/pb2bv.rs – constant-offset preservation
// ========  ========
...
// ========  ========
// nixie-core/src/model/completion.rs – sort-correct defaults
// ========  ========
...
// ========  ========
// nixie-core/src/unsat_core.rs – real deletion-based minimize_with
// ========  ========

#[test]
fn unsat_core_minimize_with_drops_unneeded_assertions() {
    use nixie_core::ast::NamedAssertion;
    use nixie_core::{TermId, UnsatCore};
...
// ========  ========
// nixie-core/src/smtlib/printer/model.rs – valid function-interpretation output
// ========  ========
