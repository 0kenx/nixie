...
//! package (`nixie-core/src/tactic/solve_eqs.rs`'s Fourier-Motzkin tactic and
//! `nixie-core/src/tactic/lia2card.rs`'s cardinality encodings).
//!
//! Findings fixed:
//!
...
use nixie_core::ast::traversal::collect_subterms;
...
fn test_lia2card_sequential_counter_aux_vars_unique_across_passes() {
    ...
    let config = Lia2CardConfig {
        encoding: nixie_core::tactic::CardinalityEncoding::SequentialCounter,
