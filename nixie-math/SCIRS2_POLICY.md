# SCIRS2 Policy Compliance - nixie-math

This document tracks compliance with SCIRS2 (SciRS2) project policies for the nixie-math crate.

## Dependencies

The nixie-math crate uses **standard Rust numerical libraries** instead of SciRS2-Core:
...
nixie-math is a **foundational mathematical library** that provides:
...
Then nixie-math could consider migrating to use it. However, for now, using standard `num-*` crates is the most practical approach for foundational mathematics.
