...
## Dependencies
- **nixie-core**: Term representation for polynomial constraints

## Provides (enables other crates)
- **nixie-nlsat**: Polynomial arithmetic, Sturm sequences, root isolation
- **nixie-theories**: Simplex algorithm for LRA/LIA
- **nixie-opt**: LP solver foundation, interior point method
