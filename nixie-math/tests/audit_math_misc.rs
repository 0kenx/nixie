...
//! (`nixie-math/src/simplex.rs`, `nixie-math/src/fast_rational.rs`,
//! `nixie-math/src/rational/mod.rs`).
//!
...
use nixie_math::rational::{
    divisor_count, divisor_sum, euler_totient, factorize, is_prime, is_square_free, mobius,
};
use nixie_math::simplex::{BoundType, Row, SimplexResult, SimplexTableau};
