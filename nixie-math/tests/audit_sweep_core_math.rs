...
use nixie_math::delta_rational::DeltaRational;
use nixie_math::fast_rational::FastRational;
use nixie_math::interval::Interval;
use nixie_math::mpfr::{ArbitraryFloat, Precision, RoundingMode};
...
// ========  ========
// nixie-math/src/interval.rs – Interval::mul openness must not exclude an
...
fn interval_mul_keeps_attainable_zero_closed() {
    ...
    assert_eq!(product.lo, nixie_math::interval::Bound::finite(rat(0)));
    assert!(
        !product.lo_open,
...
// ========  ========
// nixie-math/src/fast_rational.rs – division by zero must panic in both
...
// ========  ========
// nixie-math/src/mpfr.rs – ArbitraryFloat::one() must equal 1, not
...
// ========  ========
// nixie-math/src/delta_rational.rs – scaling by a non-integer rational must
...
// ========  ========
// nixie-math/src/polynomial/extended_ops.rs
// ========  ========
...
// ========  ========
// nixie-math/src/rewrite (via nixie-core) is covered separately in
// nixie-core/tests/audit_sweep_core_math.rs.
// ========  ========
