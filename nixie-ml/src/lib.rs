//! Nixie-ML: Machine Learning-Guided Heuristics for SMT Solving
//!
...
//!
//! ```rust
//! use nixie_ml::branching::{BranchingLearner, FeatureExtractor};
//! use nixie_ml::models::NeuralNetwork;
//!
...
//!
//! ```rust,ignore
//! use nixie_ml::tactic::TacticSelector;
//!
