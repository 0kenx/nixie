...
//! `nixie-core`'s real parser and walks the resulting term DAG to compute
...
use nixie_core::smtlib::{Command, parse_script, parse_term};
...
impl FeatureExtractor {
    ...
    ///
    /// Parses the formula with `nixie-core` and walks the resulting term DAG
