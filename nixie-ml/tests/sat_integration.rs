//! Integration tests: MLBranchingHeuristic wired into nixie-sat Solver.

use std::sync::{Arc, Mutex};

use nixie_ml::branching::{MLBranchingHeuristic, MLEnhancedVSIDS};
use nixie_sat::{BranchingHeuristic, Lit, Solver, SolverConfig, SolverResult, Var};
