# SCIRS2 Policy for nixie-nlsat

## Policy Statement

This crate (`nixie-nlsat`) is a **non-linear arithmetic SMT solver** implementing Cylindrical Algebraic Decomposition (CAD) and does **NOT** require SciRS2 dependencies.

## Rationale

### Nature of the Project
- **nixie-nlsat** implements the NLSAT algorithm for solving non-linear real and integer arithmetic constraints
...
- `nixie-core`: Core SMT infrastructure (AST, sorts, SMT-LIB parsing)
- `nixie-math`: Mathematical primitives (polynomials, intervals, Sturm sequences)
...
- `nixie-math`: Polynomial algebra and interval arithmetic
