...
// dedicated nixie-proof crate and would emit proofs for reasoning paths that are
// not yet certified. Integrate certified UNSAT with nixie-proof rather than
