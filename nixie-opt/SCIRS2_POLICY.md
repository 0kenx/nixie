# SCIRS2 Policy Compliance - nixie-opt

This document tracks compliance with SCIRS2 (SciRS2) project policies for the nixie-opt crate.

## Dependencies

The nixie-opt crate uses **standard Rust numerical libraries** instead of SciRS2-Core:
...
nixie-opt is an **optimization engine** that builds on top of nixie-core and nixie-sat. It provides:
...
Then nixie-opt could consider integrating them. However, the current implementation is self-contained and follows established research in the MaxSAT/OMT domain.
