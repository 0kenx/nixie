//! # nixie-opt
//!
//! Optimization engine for Nixie: MaxSMT and Optimization Modulo Theories (OMT).
//!
...
//!
//! ```rust,ignore
//! use nixie_opt::{MaxSatSolver, MaxSatConfig, MaxSatAlgorithm};
//!
...
//!
//! ```rust,ignore
//! use nixie_opt::{MaxSatSolver, MaxSatAlgorithm, MaxSatConfig, Weight};
//!
//! let config = MaxSatConfig::builder()
