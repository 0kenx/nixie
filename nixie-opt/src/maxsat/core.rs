...
use nixie_sat::{Lit, Solver as SatSolver, SolverResult};
...
impl SoftClause {
    ...
    pub fn is_satisfied(&self) -> bool {
        self.value == nixie_sat::LBool::True
    }
