...
//! `nixie-opt/src/maxsat/algorithms.rs`:
//!
...
use nixie_opt::smtlib::{CommandResult, OptCommand, SmtLibOptimizer};
use nixie_opt::{MaxSatAlgorithm, MaxSatConfig, MaxSatResult, MaxSatSolver, Weight};
...
/// `nixie-opt/src/smtlib.rs`: `(get-objectives)` used to hardcode
