...
Proof generation and checking for the Nixie SMT solver.

## Overview

This crate provides machine-checkable proof output, enabling verification of solver results by external proof checkers. This is a **beyond Z3** feature - while Z3 supports generic proofs, Nixie aims to generate standardized, machine-checkable proofs by default.
...
```rust
use nixie_proof::{Proof, ProofStep};
