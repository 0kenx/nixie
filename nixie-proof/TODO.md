...
**Nixie generates VERIFIABLE proofs, not just generic proof terms!**
...
## Dependencies
- **nixie-core**: Proof nodes, proof rules
- **nixie-sat**: DRAT proof recording (optional feature)

## Provides (enables other crates)
- **nixie-solver**: Proof generation for SMT
- **nixie-cli/nixie-wasm**: get-proof command
...
- [x] DRAT integration with nixie-sat (via optional feature flag)
