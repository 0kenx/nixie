...
/// use nixie_proof::proof::{ProofStep, ProofNodeId};
///
/// let mut logger = ProofLogger::create(Path::new("/tmp/proof.nixielog"))
...
mod tests {
    ...
    fn temp_log_path(name: &str) -> PathBuf {
        std::env::temp_dir().join(format!("nixie_proof_log_{}.nixielog", name))
    }
