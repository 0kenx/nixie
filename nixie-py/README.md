...
Python bindings for the Nixie SMT (Satisfiability Modulo Theories) solver.
...
if result == nixie.SolverResult.Sat:
...
if result == nixie.SolverResult.Sat:
    print("Satisfiable")
elif result == nixie.SolverResult.Unsat:
    print("Unsatisfiable")
elif result == nixie.SolverResult.Unknown:
    print("Unknown")
...
Nixie supports optimization (minimize/maximize) using the `Optimizer` class:
