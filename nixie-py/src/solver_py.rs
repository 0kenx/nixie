...
use ::nixie::core::ast::{TermId, TermKind, TermManager};
use ::nixie::core::smtlib::parse_term as smtlib_parse_term;
use ::nixie::solver::SolverResult;
...
pub struct PySolver {
    pub(crate) inner: RefCell<::nixie::solver::Solver>,
...
impl PySolver {
    ...
    pub fn new() -> Self {
        Self {
            inner: RefCell::new(::nixie::solver::Solver::new()),
...
mod tests {
    ...
    /// Regression test for audit finding infra-p3 / nixie-py::solver_py.rs:
    ...
    /// Regression test for audit finding infra-final / nixie-py::solver_py.rs:
    ...
    // exercised end-to-end via the `nixie-py/tests/test_model_bitvec_widths.py`
