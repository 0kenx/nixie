...
use ::nixie::core::ast::{RoundingMode, TermId, TermKind, TermManager};
...
pub struct PySort {
    ...
    pub(crate) id: ::nixie::core::SortId,
...
/// `nixie.Context().const_of_sort("x", "Array[" * 200000 + "Int" + "]" * 200000)`
...
pub(crate) fn parse_sort_name(
    ...
    let mut parsed: Vec<::nixie::core::SortId> = Vec::new();
