# SCIRS2 Policy for nixie-sat

## Purpose
This document describes the SciRS2 compliance policy for the nixie-sat crate, which is a high-performance CDCL SAT solver for the Nixie SMT solver framework.
...
1. **nixie-core** (workspace dependency)
   - Core types and utilities for Nixie
