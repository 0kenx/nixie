//! Soundness regression sibling: the adaptive-retention arm on the satisfiable
...
#[test]
fn adaptive_reduce_never_yields_wrong_unsat() {
    ...
    unsafe {
        std::env::set_var("NIXIE_REDUCE_ADAPT", "1");
    }
