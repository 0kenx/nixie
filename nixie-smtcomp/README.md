...
SMT-COMP benchmark infrastructure for Nixie SMT solver.

## Overview

This crate provides tools for running SMT-COMP benchmarks and evaluating Nixie performance:
...
```rust
use nixie_smtcomp::{BenchmarkRunner, BenchmarkConfig};
...
- `nixie-core` - Core SMT-LIB parsing
- `nixie-solver` - SMT solver
