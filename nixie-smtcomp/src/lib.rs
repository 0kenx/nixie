//! Nixie SMT-COMP - Benchmark Infrastructure
//!
...
//!
//! ```no_run
//! use nixie_smtcomp::{Loader, LoaderConfig, Runner, RunnerConfig, Reporter};
...
//!
//! ```no_run
//! use nixie_smtcomp::parallel::{ParallelRunner, ParallelConfig};
//! use nixie_smtcomp::Loader;
//! use std::time::Duration;
//!
...
//!
//! ```
//! use nixie_smtcomp::{SolverComparison, SingleResult, BenchmarkStatus, BenchmarkMeta};
//! use nixie_smtcomp::loader::ExpectedStatus;
//! use std::time::Duration;
