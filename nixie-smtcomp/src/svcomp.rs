...
//! task definition YAML files and integrating them with the Nixie SMT benchmark pipeline.
//!
...
//!
//! ```no_run
//! use nixie_smtcomp::svcomp::SvCompReader;
//! use std::path::Path;
//!
...
impl SvCompReader {
    ...
    /// (see `nixie_smtcomp::logic_detector`) if needed.
    ///
