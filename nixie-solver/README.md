...
- **Native Generic Sequences** - `Seq T` with exact finite-shape reduction and
  independently validated models. See [supported operations and limits](../docs/NATIVE_SEQUENCES.md).
