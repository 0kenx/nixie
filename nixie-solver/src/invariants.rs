...
//! decision level – those live inside [`nixie_sat::Solver`] and are already
//! covered by `nixie_sat::invariants`. The `Solver::trail` field here is an
