...
macro_rules! mbqi_time {
    ($name:expr, $block:block) => {{
        #[cfg(feature = "std")]
        let start = nixie_time::Instant::now();
        let result = $block;
        #[cfg(feature = "std")]
        {
...
///
/// [`TermManager`]: nixie_core::ast::TermManager
///
...
/// and `nixie-theories`' proof-instantiation checker all treat the
...
/// `nixie_core::ast::traversal::collect_free_vars` did with their own
/// duplicate walks.
///
...
pub mod utils {
    ...
    ///
    /// [`TermManager::free_vars_including_patterns`]: nixie_core::ast::TermManager::free_vars_including_patterns
    ...
    /// Nixie is what makes substitution under a binder correct at all,
    ...
    /// the workspace uses.
    ///
    /// [`TermManager::term_depth`]: nixie_core::ast::TermManager::term_depth
    ...
    ///
    /// [`TermManager::term_size`]: nixie_core::ast::TermManager::term_size
