...
use nixie_theories::string::{eval_ground_bool, solve_ground_string_model};
...
impl Solver {
    ...
    ///
    /// [`nixie_theories::string::solve_ground_string_model`] can already
    ...
    /// ([`nixie_theories::string::solve_ground_string_model`]).
    ///
