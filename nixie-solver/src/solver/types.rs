...
use nixie_sat::{Lit, RestartStrategy, Var};
...
pub struct SolverConfig {
    ...
    /// NIA-over-LP relaxation engine (`nixie_theories::arithmetic::nla`):
                ...
                match t.kind {
                    ...
                    TermKind::Let { bindings, body } => {
                        ...
                        for (name, value) in bindings.iter().rev() {
                            substituted = nixie_core::tactic::quantifier::substitute_single_var(
                                manager,
                                substituted,
                                *name,
                                *value,
...
impl Model {
    ...
    fn format_sort(sort: nixie_core::sort::SortId, manager: &TermManager) -> String {
