...
//!
//! This module provides a Z3-style API surface over Nixie's native solver API.
...
//! - [`Z3Context`] owns a [`nixie_core::ast::TermManager`] and a [`Z3Config`].
...
//!
//! ```
//! use nixie_solver::z3_compat::{Z3Config, Z3Context, Z3Solver, SatResult};
//! use nixie_solver::z3_compat::Bool;
//!
