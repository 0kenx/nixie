...
///
/// Internally delegates to [`nixie_core::ast::TermManager::mk_forall`].
#[must_use]
...
/// The body is a [`Bool`] term that may reference variables with those names.
///
/// Internally delegates to [`nixie_core::ast::TermManager::mk_exists`].
#[must_use]
...
pub struct Z3Optimize {
    ...
    ctx_tm: std::rc::Rc<std::cell::RefCell<nixie_core::ast::TermManager>>,
...
impl Z3Optimize {
    ...
    fn term_to_string(tm: &nixie_core::ast::TermManager, id: TermId) -> String {
