...
use nixie_solver::{Context, SolverResult, TheoryMode};
...
///
/// `z3` answers `sat`; this pins that nixie agrees.  The Euclidean constants
/// involved – `(div 7 7) = 1`, `(mod (- 3) (- 5)) = 2`, `(abs 7) = 7` – are
/// covered independently by `nixie-core/tests/audit_div_semantics.rs`.
#[test]
