...
//! dispatch (see `nixie-theories/tests/pr27_nia_divmod.rs`, which covers
...
//! `nixie-solver/src/solver/types.rs` had no case for `TermKind::Div`/`Mod`
...
/// `x=3`. `nixie-theories`' independent `resolve_int_divisor` (the QF_NIA
/// dispatch path, see
/// `nixie-theories/tests/pr27_nia_divmod.rs::test_pr27_nia_divmod_folded_divisor_expression_is_sat`,
