# SCIRS2 Policy for nixie-spacer
...
✅ **Compliant** - This crate currently does not require numerical/random computations beyond what's provided by standard Rust and the core nixie infrastructure.

## Rationale

The nixie-spacer crate focuses on:
...
The crate relies on:
- `nixie-core`: Core term management and SMT-LIB parsing
- `nixie-solver`: SMT solver integration
...
Run `cargo tree -p nixie-spacer` to verify no prohibited dependencies are included.
