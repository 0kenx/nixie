...
pub struct Predicate {
    ...
    pub params: SmallVec<[nixie_core::SortId; 4]>,
}
...
pub struct Rule {
    ...
    pub vars: SmallVec<[(String, nixie_core::SortId); 4]>,
    /// Body of the rule
    pub body: RuleBody,
    /// Head of the rule
    pub head: RuleHead,
...
impl ChcSystem {
    ...
    pub fn declare_predicate(
        ...
        params: impl IntoIterator<Item = nixie_core::SortId>,
    ) -> PredId {
        let name = name.into();
    ...
    pub fn add_rule(
        &mut self,
        vars: impl IntoIterator<Item = (String, nixie_core::SortId)>,
        body: RuleBody,
        head: RuleHead,
        name: Option<String>,
    ) -> RuleId {
