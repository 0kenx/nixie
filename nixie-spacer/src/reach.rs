...
pub struct ConcreteWitnessExtractor<'a> {
    /// Term manager
    terms: &'a mut nixie_core::TermManager,
    /// CHC system
...
impl<'a> ConcreteWitnessExtractor<'a> {
    ...
    pub fn new(terms: &'a mut nixie_core::TermManager, system: &'a crate::chc::ChcSystem) -> Self {
        Self { terms, system }
    }
...
mod tests {
    ...
    fn test_reach_fact_creation() {
        ...
        let fact = nixie_core::TermId::new(42);
    ...
    fn test_reach_fact_justification() {
        ...
        let fact1 = nixie_core::TermId::new(1);
        let fact2 = nixie_core::TermId::new(2);
    ...
    fn test_under_approximation() {
        ...
        let pred = PredId::new(0);
        let state1 = nixie_core::TermId::new(1);
        let state2 = nixie_core::TermId::new(2);
        ...
        assert!(!under.contains(pred, nixie_core::TermId::new(3)));
    }
    ...
    fn test_over_approximation() {
        ...
        let pred = PredId::new(0);
        let lemma1 = nixie_core::TermId::new(1);
        let lemma2 = nixie_core::TermId::new(2);
    ...
    fn test_generalization() {
        let cube = [
            nixie_core::TermId::new(1),
            nixie_core::TermId::new(2),
            nixie_core::TermId::new(3),
        ];
        ...
        generalization.drop_literal(nixie_core::TermId::new(2));
