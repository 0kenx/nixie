...
use nixie_core::tactic::Goal;
use nixie_spacer::BmcUnrollTactic;
...
fn test_bmc_unroll_feeds_bmc_engine() {
    ...
    match result {
        nixie_core::tactic::TacticResult::SubGoals(ref subgoals) => {
        ...
        nixie_core::tactic::TacticResult::NotApplicable => {
            panic!(
