...
//!
//! ```ignore
//! use nixie_theories::{TheoryCombiner, CombinationConfig};
//! use nixie_theories::euf::EufSolver;
//! use nixie_theories::arithmetic::LraSolver;
//!
...
//!
//! ```ignore
//! use nixie_theories::user_propagator::{UserPropagator, PropagatorCallback};
//!
//! struct MyPropagator;
//!
