...
impl RecFunSolver {
    ...
    pub fn define_function(
        ...
        if self.name_to_id.contains_key(&name) {
            return Err(NixieError::Internal("Function already defined".to_string()));
        }
        ...
        self.next_id = self
            .next_id
            .checked_add(1)
            .ok_or_else(|| NixieError::Internal("RecFunId overflow".to_string()))?;
