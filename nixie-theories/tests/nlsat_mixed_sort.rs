...
use nixie_theories::nlsat::{NlDispatchResult, dispatch_nia_constraints, dispatch_nra_constraints};
...
fn test_qf_nira_int_square_with_real_half_is_sat() {
    ...
    let result = dispatch_nia_constraints(&[eq_sq, eq_y], &mut manager, true, true);
...
fn test_qf_nira_sat_requires_non_integral_real() {
    ...
    let result = dispatch_nia_constraints(&[eq_y_sq, x_gt_0, x_lt_1], &mut manager, true, true);
...
fn test_nia_dropped_disjunction_does_not_fabricate_sat() {
    ...
    let result = dispatch_nia_constraints(&[eq_prod, disj], &mut manager, true, true);
...
fn test_nia_untranslatable_operand_does_not_fabricate_sat() {
    ...
    let result = dispatch_nia_constraints(&[eq_sq, eq_div], &mut manager, true, true);
