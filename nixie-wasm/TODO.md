...
- [x] TypeScript declarations file (nixie-wasm.d.ts)
...
- [x] React wrapper with hooks and context (@nixie/react)
- [x] Vue 3 wrapper with composables and stores (@nixie/vue)
- [x] Svelte wrapper with stores and composables (@nixie/svelte)
