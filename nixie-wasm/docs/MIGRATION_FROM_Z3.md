# Migration Guide: Z3 JavaScript to Nixie WASM

This guide helps you migrate from Z3's JavaScript bindings to Nixie WASM.

## Overview

Nixie WASM provides a similar API to Z3's JavaScript bindings but with some differences in initialization, naming conventions, and available features.
...
| `await solver.check()` | `solver.checkSat()` | Synchronous in Nixie |
...
Nixie uses SMT-LIB2 syntax for formulas. Here's a quick reference:
...
- **Documentation**: Check the Nixie WASM README
