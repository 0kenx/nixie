# Nixie WASM Tutorial: Beginner's Guide

Welcome to Nixie! This tutorial will teach you the basics of using the Nixie SMT solver in your JavaScript applications.
...
<head>
  <script type="module">
    import init, { WasmSolver } from './path/to/nixie_wasm.js';
