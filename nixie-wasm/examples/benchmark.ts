/**
 * Performance benchmarks for Nixie WASM (TypeScript version)
 *
 * Tests various operations and measures execution time
 */

import { WasmSolver, version } from '../pkg/nixie_wasm';
...
export function runBenchmarks(): void {
    ...
    console.log(`Nixie WASM Performance Benchmarks v${version()}`);
    console.log('='.repeat(60));
    console.log();
