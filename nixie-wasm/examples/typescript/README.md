# Nixie WASM TypeScript Examples

This directory contains TypeScript examples demonstrating type-safe usage of the Nixie WASM SMT solver.
...
The project uses the TypeScript declarations from `nixie-wasm.d.ts` which provide:
...
```typescript
import init, { WasmSolver } from 'nixie-wasm';
...
- Read the API documentation in `../../nixie-wasm.d.ts`
