/**
 * Basic TypeScript example for Nixie WASM
 *
 * This example demonstrates type-safe usage of the Nixie SMT solver
 * from TypeScript.
 */

import init, { WasmSolver, version, type Model, type SatResult } from '../../nixie-wasm';
...
async function main(): Promise<void> {
    console.log(`Nixie WASM TypeScript Examples`);
