...
//!
//! Provides JavaScript/TypeScript bindings for running Nixie in the browser.
...
///
/// This is the main interface for using Nixie from JavaScript/TypeScript.
...
/// Get the version of Nixie WASM
///
/// Returns the current version string of the Nixie WASM library.
///
/// # Returns
///
