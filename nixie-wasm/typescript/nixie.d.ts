// Nixie WASM – TypeScript type definitions
// Mirrors nixie-wasm::js_api::typescript::generate_typescript_dts()
// See also: nixie-wasm/src/js_api/typescript.rs

/** The result returned by {@link NixieSolver.check} and {@link solve}. */
...
/** Configuration options accepted by the {@link NixieSolver} constructor. */
...
/**
 * Return the Nixie WASM library version string.
 *
