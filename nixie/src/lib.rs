//! # Nixie - Next-Generation SMT Solver in Pure Rust
//!
...
//! ```toml
//! [dependencies]
//! nixie = "0.3.2"  # Default: std + core solver
//! ```
//!
//! For no_std (e.g., zkVM):
//!
//! ```toml
//! [dependencies]
//! nixie = { version = "0.3.2", default-features = false }
//! ```
//!
...
pub use nixie_core as core;
pub use nixie_math as math;

// Re-export solver components (always available now)
pub use nixie_sat as sat;
pub use nixie_solver as solver;
pub use nixie_solver::{Solver, SolverResult};
pub use nixie_theories as theories;

// Re-export core types for convenience
pub use nixie_core::{Sort, SortId, Term, TermId, TermManager};

#[cfg(feature = "std")]
#[cfg_attr(docsrs, doc(cfg(feature = "std")))]
pub mod easy;

pub use nixie_solver::resource_limits;

// Re-export advanced features (require std)
#[cfg(feature = "nlsat")]
#[cfg_attr(docsrs, doc(cfg(feature = "nlsat")))]
pub use nixie_nlsat as nlsat;

#[cfg(feature = "optimization")]
#[cfg_attr(docsrs, doc(cfg(feature = "optimization")))]
pub use nixie_opt as opt;

#[cfg(feature = "spacer")]
#[cfg_attr(docsrs, doc(cfg(feature = "spacer")))]
pub use nixie_spacer as spacer;

#[cfg(feature = "proof")]
#[cfg_attr(docsrs, doc(cfg(feature = "proof")))]
pub use nixie_proof as proof;

/// Current version of Nixie
